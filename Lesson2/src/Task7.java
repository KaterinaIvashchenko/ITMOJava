 ...
 * «осталось 4 часа», «остался 1 час», «осталось менее часа». Итак, в переменную n должно записываться случайное
 * (на время тестирования программы) целое число из [0;28800], далее оно должно выводиться на экран (для Петрова)
...
public class Task7 {
    public static void main(String[] arts) {
        ...
        System.out.print(seconds + " - oсталось ");

        if (hours < 1) {
            System.out.println("менее часа.");
        } else if (hours == 1) {
            System.out.println(hours + " час");
